...
A React library which provides Flexible cool Animated Menubar with an easy to use API and a bunch of other awesome features . Also you can change the background color and text color of the menubar.
...
1. **Fully Flexible:** The menubar items are completely flexible and absolute positioned, You can use wherever you want.It won't affect other components.
